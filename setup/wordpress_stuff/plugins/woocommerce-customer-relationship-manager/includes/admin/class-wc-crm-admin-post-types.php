    ...
    class WC_CRM_Admin_Post_Types
    {
        ...
        public function register_post_type($post_type = '', $options = array(), $single = '', $plural = '')
        {
            ...
            $labels = array(
                ...
                'add_new' => sprintf(__('Add %s', 'wc_crm'), $single),
        ...
        public function wc_crm_tasks_custom_columns($column, $post_id)
        {
            ...
            switch ($column) {
                ...
                case 'customer_n_account' :
                    ...
                    if ($customer) {
                        $customer_row = wc_crm_get_customer($customer, 'user_id');
                        $the_customer = new WC_CRM_Customer($customer_row->c_id);
                        ...
                        printf('<a href="admin.php?page=wc_crm&c_id=%d" target="_blank" class="tips" data-tip="%s">%s</a>', $customer_row->c_id, $user_contact, $user_string);
                    }
                    if ($account) {
