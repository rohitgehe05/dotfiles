	...
	private function intro() {
		...
		<div class="about-text woocommerce-about-text">
			<?php
				...
				printf( __( '%s WooCommerce Customer Relationship Manager %s helps you manage your existing and potential customers at your WooCommerce store.', 'wc_crm' ), $message, $major_version );
			?>
		</div>
