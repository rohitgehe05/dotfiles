...
class WC_CRM_Admin_Setup_Wizard {
	...
	public function wc_crm_setup_load_customers() {
		...
		<p class="wc-setup-actions step" id="load_customers_buttons">
			<input type="button" id="force_reload_customers" name="force_reload_customers" class="button-primary hide-if-no-js button-large" value="<?php esc_attr_e( 'Start load', 'wc_crm' ); ?>" />
