      ...
      ");
        ...
        public function wc_crm_parse_query($query)
        {
            if (isset($_GET['post_type'])) {
                ...
                if ($_GET['post_type'] == 'wc_crm_calls' && $_GET['wc_crm_call_type'] && $_GET['wc_crm_call_type'] != 'all') {
                    $query->query_vars['meta_key'] = '_type';
                    $query->query_vars['meta_value'] = $_GET['wc_crm_call_type'];
                }
                if ($_GET['post_type'] == 'wc_crm_calls' && $_GET['_customer_user'] && $_GET['_customer_user'] != 'all') {
                    $query->query_vars['meta_key'] = '_customer_id';
                    $query->query_vars['meta_value'] = $_GET['_customer_user'];
                }
                if ($_GET['post_type'] == 'wc_crm_calls' && $_GET['_call_owner'] && $_GET['_call_owner'] != 'all') {
